...
class CommanderConfig:
    ...
    def from_env(cls, env_file: Path | None = None) -> "CommanderConfig":
        ...
        config = cls(
            ...
            review_min_interval_seconds=_float("AI_REVIEW_MIN_INTERVAL_SECONDS", 2700.0),
            review_max_idle_interval_seconds=_float("AI_REVIEW_MAX_IDLE_INTERVAL_SECONDS", 14400.0),
            review_event_debounce_seconds=_float("AI_REVIEW_EVENT_DEBOUNCE_SECONDS", 180.0),
